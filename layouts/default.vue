        ...
        <v-navigation-drawer v-model="drawer" fixed left class="d-block">
          ...
          <v-container class="d-block menu-items">
            <div class="d-flex flex-column">
              ...
              <div class="d-flex">
                <nuxt-link to="/calamity">
                  <v-icon>mdi-alarm-light</v-icon>&nbsp;&nbsp;<b>Calamity</b>
                </nuxt-link>
              </div>
              <div class="d-flex">
                <nuxt-link to="/evacuation">
                  <v-icon>mdi-hoop-house</v-icon>&nbsp;&nbsp;<b>Evacuation Center</b>
                </nuxt-link>
              </div>
              <div class="d-flex">
                <nuxt-link to="/evacuee">
                  <v-icon>mdi-view-dashboard-variant-outline</v-icon>&nbsp;&nbsp;<b>Evacuees</b>
                </nuxt-link>
              </div>
              <div class="d-flex">
